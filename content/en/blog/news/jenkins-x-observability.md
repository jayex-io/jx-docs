...
> [!NB] NOTE: Tracing is only a small portion of other things that need to be in place.  Logging and Metrics are also required.  The combination and aggregation of this data allows you to understand how observable your pipeline is.
...
> [!NOTE]
> Please be sure to sign up for [honeycomb.io](http://honeycomb.io) to obtain your **API Key**
